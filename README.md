...
# CurrentCost2Mqtt
A gateway to publish current cost energy monitor values to a MQTT broker
...
And finally here is the code and the instructions to setup an Current Cost to MQTT gateway and how to get the values in Home Assistant.
